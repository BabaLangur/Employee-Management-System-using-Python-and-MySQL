...
class view:
    def __init__(self) :
        ...
        self.root = Tk()
        self.root.title("VIEW PAID EMPLOYYES")
        self.root.geometry("990x800+600+00")

        title = Label(self.root, text="Employee Payment View", bd=10, font=("new times roman", 40, "bold"),
...
########################################################################################################################################################################
        ...
        view_Frame = Frame(main_Frame, bd=4, relief=RIDGE, bg="light blue")
        ...
        btn_Frame = Frame(main_Frame, bd=0, bg="light blue")
        btn_Frame.place(x=10, y=560, width=900, height=70)


        Button(btn_Frame, text="Exit", font=("new times roman", 15), width=15, bg="light blue",command=self.exit).grid(row=0, column=1, padx=10, pady=10)
        Button(btn_Frame, text="Back", font=("new times roman", 15), width=15, bg="light blue",command=self.back).grid(row=0, column=0, padx=10, pady=10)
